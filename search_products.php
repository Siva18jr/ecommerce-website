      ...
      <tbody>
         <?php
            ...
            if(!empty($_POST['startDate']) and empty($_POST['endDate'])){
                ...
                echo "<center><h1>Products added from ".$new_sdate."</h1></center>";
            
            }
            
            else if(isset($_POST['startDate']) && isset($_POST['endDate'])){
                
                echo "<center><h1>Products added between ".$new_sdate." and ".$new_edate."</h1></center>";
         ...
         <tr>
            <td><img src="imag/<?php echo $row['image']; ?>" height="100" alt=""></td>
