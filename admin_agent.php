...
<section class="user-table" style="padding-top:0;">
   <table>
      ...
      <tbody>
         ...
         $result = mysqli_query($conn, "SELECT * FROM `users` where user_type='agent'");
         ...
         <tr>
            ...
            <td id="remove">
            <a id="remove" href="admin_agent.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('delete this agent?');" class="delete-btn">
         ...
         <?php
            ...
            echo "<div class='empty'>no agent found!</div>";
